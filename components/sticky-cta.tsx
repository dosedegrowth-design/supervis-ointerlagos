  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 hidden flex-col items-end gap-3 md:flex">
      ...
      <a
        ...
        className="animate-pulseZap flex items-center gap-3 rounded-full bg-zap px-5 py-4 font-bold text-white shadow-xl shadow-zap/40 transition hover:bg-zap-dark"
      >
